...
const { verificaNome, resetarAllLimit, resetTodayReq, banir, desbanir, checkBanimento, addcodiguin, enviar_email, getemail } = require('../backend/db');
...
enviar_email(`${username} seu premium foi deletado pelo administrador`, emailer)
